                ...
                if cleaned_input.lower() in FIVE_LETTER_WORDS:
                    ...
                    for col, guess_letter in enumerate(cleaned_input):
                        ...
                        if guess_letter == word_letter:
                            ...
                            remaining_word[
                                col
                            ] = None  # Remove this letter from remaining_word

                    # Second Pass: Check for presence in wrong positions
                    for col, guess_letter in enumerate(cleaned_input):
                        if (
                            square_colors[col] == MISSING_COLOR
                            and guess_letter in remaining_word
                        ):
                            square_colors[col] = PRESENT_COLOR
                            remaining_word[
                                remaining_word.index(guess_letter)
                            ] = None  # Remove one occurrence
